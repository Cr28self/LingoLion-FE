...
import { SituationCard } from '@/domains/dashboard-situations/components/situation-card.tsx';
import useInfiniteScroll from '@/hooks/use-infinite-scroll.ts';
import { useGetInfiniteSituations } from '@/domains/dashboard-situations/api/get-situations.ts';
import { TSituation } from '@/types/situation.ts';
import { SkeletonCardSitu } from '@/domains/dashboard-common/components/contents-skeleton-loading.tsx';

type SituationWithMeta = TSituation & { id: number; createdAt: Date };

const ExploreSituationsPage = () => {
...
export default ExploreSituationsPage;
