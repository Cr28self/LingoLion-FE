...
import { useDeleteSituation } from '@/domains/dashboard-situations/api/delete-situations.ts';
import { useUpdateSituation } from '@/domains/dashboard-situations/api/update-situation.ts';
import { useMakeConversation } from '@/domains/dashboard-situations/api/make-conversation.ts'; // Import useNavigate
