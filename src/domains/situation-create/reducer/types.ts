...
// 3. 매핑 타입의 키들을 가져옵니다. ('place' | 'userRole' | 'aiRole' | 'goal')
type RecommendationKey = keyof TRecommendationCategories;
...
export type TSetRecListParams = ActionObjectMap[RecommendationKey];
